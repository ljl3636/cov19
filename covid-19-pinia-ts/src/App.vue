<template>
  <div :style="{ background: `url(${bg})` }" class="box">
    ...
    <div class="box-center">
      <h3 style="color:aliceblue;position: absolute; top: 100px; font-style: italic; font-size: 30px;">The Covid-19 in China</h3>
    ...
    <div style="color:white" class="box-right">
      <table class="table" cellspacing="0" border="1">
        ...
        <transition-group enter-active-class="animate__animated animate__flipInY" tag="tbody">
          <tr :key="`${item.name}-${index}-${item.adcode}-${item.total.mtime}-${item.total.confirm}`"
            ...
            <td align="center">{{ item.total.highRiskAreaNum}}</td>
            <td align="center">{{ item.total.mediumRiskAreaNum}}</td>
          </tr>
        </transition-group>
      </table>
    </div>
